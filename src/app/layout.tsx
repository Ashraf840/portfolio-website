...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="!scroll-smooth">
      <body className={`${inter.className} bg-gray-50 text-gray-950 relative h-[5000px] pt-28 sm:pt-36 dark:bg-gray-950 dark:text-gray-50 dark:text-opacity-90 transition-colors`}>
